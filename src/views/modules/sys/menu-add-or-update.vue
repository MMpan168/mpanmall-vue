      ...
      <el-form-item v-if="dataForm.type !== 2" label="Icon" prop="icon">
        <el-row>
          <el-col :span="22">
            ...
            <el-input v-model="dataForm.icon" v-popover:iconListPopover :readonly="true" placeholder="Icon Selection" class="icon-list__input"></el-input>
          </el-col>
          <el-col :span="2" class="icon-list__tips">
            <el-tooltip placement="top" effect="light">
              <div slot="content">recommand to use SVG Sprite, refer to:<a href="//github.com/daxiongYang/renren-fast-vue/blob/master/src/icons/index.js" target="_blank">icons/index.js</a> discription</div>
