    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">MPan Mall</h2>
          <p class="brand-info__intro">E-commerce that deliver fresh produce in 30 min, serving community since 2024</p>
        </div>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          userName: [
            { required: true, message: 'username can not be blank', trigger: 'blur' }
          ],
          password: [
            { required: true, message: 'password can not be blank', trigger: 'blur' }
          ],
          captcha: [
            { required: true, message: 'Verification code can not be blank', trigger: 'blur' }
          ]
        },
        captchaPath: ''
      }
